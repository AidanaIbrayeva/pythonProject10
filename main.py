...
while loop:
    ...
    for event in pygame.event.get():
        ...
        if pygame.mouse.get_pressed() == (1, 0, 0):  # pressionou o mouse
            if (
                    pygame.time.get_ticks() - last_time > BULLET_RATE):  # Se o tempo passado do ultimo tiro for maior que a taxa de tiro, atira a bala
    ...
    pygame.draw.line(window, colors['blue'], [(int)(screen_width / 2), screen_height - BALL_RADIUS], [int(x), int(y)],
                     WIDTH_LINE)  # desenha uma linha da posicao de lancamento ate o mouse
